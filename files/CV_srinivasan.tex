...
%   \href{krishna.srinivasan@unidistance.ch}{krishna.srinivasan@univie.ac.at}
% \end{center}
...
\begin{rSection}{Contact Information}
  \begin{tabular}{ @{} >{}l @{\hspace{19.5ex}} l }
    ...
    Schinerstrasse 18 &  \href{mailto:krishna.srinivasan@unidistance.ch}{krishna.srinivasan@univie.ac.at} 
    \\
...
\begin{rSection}{Publications}
    ``Fairness perceptions of redistribution and predistribution'' (with Justin Valasek and Weijia Wang). \textbf{Journal of Public Economics}, 2026, 262, 105752.
\end{rSection}

\begin{rSection}{Working Papers}

  ``Paternalism: Determinants of Demand and Supply'' (with Bj\"{o}rn Bartling). Revise and Resubmit, \textbf{Management Science.}
...
\begin{rSection}{Work in Progress}
  ...
  ``Optimal Pigouvian Taxes with Altruism'' (with William Dodds)
...
\begin{rSection}{Academic Service}
  \textbf{Refereeing}: Experimental Economics, Journal of the European Economic Association, Journal of Political Economy -- Micro, Journal of Public Economics, Journal of Economic Behavior and Organization, Oxford Bulletin of Economics and Statistics, Oxford Economic Papers 

  \textbf{Organization}: Valais Economics Workshop: Behavioral Public Economics (2026)
\end{rSection}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{rSection}{Invited Seminars, Conferences and Workshops, and Summer Schools}

  \textbf{Invited Seminars:} \textbf{2026:} Universidad Torcuato Di Tella  \textbf{2025:} Tulane University, Helmut Schmidt University -- Hamburg, University of Cologne (C-SEB) \textbf{2023:} M.S. Ramaiah University of Applied Sciences

  \textbf{Conferences and Workshops:} \textbf{2026:} Mannheim Taxation Conference, Workshop on Behavioral Public Economics and Political Economy (University of Vienna), Annual Congress of the IIPF \textbf{2025:} Lofoten International Symposium on Inequality and Taxation, Ludwig Erhard ifo Conference on Institutional Economics, CESifo Area Conference on Public Economics \textbf{2024:}  Verein f\"ur Socialpolitik, ESA World Meeting (Bogota), URPP Taxation \& Inequality Conference (poster) \textbf{2023:}

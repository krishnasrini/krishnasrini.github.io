...
\usepackage[a4paper, left=0.64in,top=0.9in,right=0.75in,bottom=0.9in]{geometry}
...
\begin{rSection}{Working Papers}
    ...
    { \normalsize  \hspace*{1.3em} Reject and Resubmit at the American Economic Review }\\\vspace{0.1em}
...
\begin{rSection}{Conferences and Inivited Seminars (including scheduled)}
    \textbf{2025:} Ludwig Erhard ifo Conference on Institutional Economics (scheduled), CESifo Area Conference on Public Economics (scheduled) \textbf{2024:}  Verein F\"ur Socialpolitik, ESA World Meeting Bogota, URPP Taxation \& Inequality Conference (poster) \textbf{2023:}
